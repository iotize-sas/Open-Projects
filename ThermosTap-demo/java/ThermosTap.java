...
public class ThermosTap {
    ...
    public Pin                             pinTurnPowerOnOff            = new Pin(Pin.TGT_NRST, Pin.PP_OUT, Pin.HIZ);
    // Get current temperature with Volt on TempSensor
    public Pin                             pinTempSensor                = new Pin(Pin.TGT_TXD, Pin.ANA, Pin.HIZ);
    ...
    public void check(final int id) {
        ...
        */
        if(id == CURRENT_TEMP_ID) {
            currentTemp_varInTap.setValue(20);
        }
